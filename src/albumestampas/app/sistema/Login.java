...
public class Login {
    ...
    public void mostrarLogin(){
        ...
        App.ventana.setTitle("Inicio Sesion - Biblioteca");
       ...
       //panelHeader.add(btnRegresar, BorderLayout.WEST);
        ...
        App.panel.add(contenidoLogin, "contenidoLogin");
    ...
    private class InicioSesion implements ActionListener{
        ...
        public void actionPerformed(ActionEvent ae) {
            if (App.listaUsuarios.validarUsuario(nick.getText(), String.valueOf(contraseña.getPassword()))) {
                JOptionPane.showMessageDialog(null, "Sesion iniciado");
                App.listaUsuarios.setActual(App.listaUsuarios.buscarUsuarioPorReferencia(nick.getText()));
